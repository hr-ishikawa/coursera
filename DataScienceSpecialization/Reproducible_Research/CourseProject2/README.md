...
- RStudio: publish your completed analysis document to RPubs.
- knitr:  R Markdown document and convert it to HTML
...
2. Click the KnitHTML button in the doc toolbar to preview your document.
